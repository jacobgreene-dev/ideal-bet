        ...
        <div>
            <div className="bg-cover bg-center min-h-screen flex flex-col items-center justify-center">
                ...
                <div className="flex flex-col m-4 text-xl">
                    <h2><a href="/information/moneyline">Link to Moneyline bets</a></h2>
                    <p><a href="/information/over-under">Link to Over/Under bets</a></p>
                    <p><a href="/information/spread">Link to Spread bets</a></p>
                </div>
            </div>
