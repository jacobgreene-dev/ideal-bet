      ...
      <nav className="mx-auto flex max-w-8xl items-center justify-between px-4 py-4 sm:px-6" aria-label="Global">
        ...
        {isClient && (
          <PopoverGroup className="hidden sm:flex sm:gap-x-8">
            <Popover className="relative">
              ...
              <PopoverPanel className="absolute top-full z-10 mt-2 w-screen max-w-md overflow-hidden rounded-3xl bg-[#2b3340] ring-1 shadow-lg ring-white/5">
                <div className="p-4">
                  {NBA.map((item) => (
                    <div
                      key={item.name}
        ...
        {session ? (
          <div className="hidden sm:flex sm:items-center sm:space-x-4 sm:flex-1 sm:justify-end">
            <div className="flex items-center space-x-2 bg-gray-800/60 px-3 py-1 rounded-lg shadow-sm border border-gray-700">
              <Image
          ...
          <div className="hidden sm:flex sm:flex-1 sm:justify-end">
            <button
              ...
              className="text-sm text-white bg-sky-500 hover:bg-sky-600 px-4 py-2 rounded-full shadow-lg transition-transform transform hover:scale-105 hover:text-bold"
            >
              Log in
            </button>
          </div>
